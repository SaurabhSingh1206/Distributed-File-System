...
public class Client1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(Colors.ANSI_GREEN + "Client 1 connected to server !" + Colors.ANSI_RESET);
        String command = "";
        do {
            System.out.print("~$ ");
            command = br.readLine();
        ...
        System.out.println(Colors.ANSI_RED + "Client 1 disconnected !" + Colors.ANSI_RESET);
    }
}
