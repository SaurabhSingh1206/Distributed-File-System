...
public class Client3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(Colors.ANSI_GREEN + "Client 3 connected to server !" + Colors.ANSI_RESET);
        String command = "";
        do {
            System.out.print("~$ ");
            command = br.readLine();
        ...
        System.out.println(Colors.ANSI_RED + "Client 3 disconnected !" + Colors.ANSI_RESET);
    }
}
